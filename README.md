...
CopyGAT.ipynb serves as the running module of the model.File, cc_genes, bin_size=25, max_cp=15, intermediate_dim=128, latent_dim=20, batch_size=128, epochs=200, number_of_clones=2 are the default parameters of the model. The best performance for different datasets occurs under different settings.
...
I will provide the dataset DCIS (GSM4476485) used in the paper as an example to implement the method.
